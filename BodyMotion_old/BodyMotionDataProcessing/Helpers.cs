...
namespace BodyMotionDataProcessing
{
    internal class Helpers
    {
        ...
        /// <summary>
        /// Get speed of a joint in m/s between two positions
        /// </summary>
        /// <param name="position1"></param>
        /// <param name="position2"></param>
        /// <param name="time">Time in ms</param>
        /// <returns></returns>
        internal static double GetSpeed(Vector3 position1, Vector3 position2, double time)
        {
            var changeX = position1.X - position2.X;
            var changeY = position1.Y - position2.Y;
            var changeZ = position1.Z - position2.Z;

            var velocityX = changeX / time;
            var velocityY = changeY / time;
            var velocityZ = changeZ / time;
